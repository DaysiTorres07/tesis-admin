      ...
      <Disclosure as="nav">
        ...
        <div className="p-6 w-1/2 h-screen bg-white z-20 fixed top-0 -left-96 lg:w-1/6 lg:left-0 peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
          <p style={{
                  ...
                  fontStyle: "normal",
                  fontSize: "15px",
                }}>Usuario: <strong>{`${auth?.userName}`}</strong></p>
          <div className="flex flex-col justify-start items-center">
            ...
            <div className="my-4 border-b border-gray-100 pb-4">
              ...
              {CheckPermissions(auth, [0, 4, 5, 14, 15, 16, 17, 18]) && (
                <div>
                  {mostrarCarga && (
                    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-white z-50">
                      <Image
              ...
              {CheckPermissions(auth, [0, 4, 5, 18, 32]) && (
                <div>
                  {mostrarCarga && (
                    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-white z-50">
                      <Image
              ...
              {CheckPermissions(auth, [0, 2, 3, 4, 5, 6, 7, 9, 10]) && (
                <div>
                  {mostrarCarga && (
                    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-white z-50">
                      <Image
              ...
              {CheckPermissions(auth, [0, 10, 33]) && (
                <div>
                  ...
                  <Link href="/rrhh">
                    <button className="w-full" onClick={handleChanges}>
                      <div className="flex mb-2 justify-start items-center gap-4 px-5 hover:bg-gray-900 p-2 rounded-full group cursor-pointer hover:shadow-lg m-auto">
                        <FiUsers className="text-2xl text-gray-600 group-hover:text-white" />
                        <h3 className="text-base text-gray-800 group-hover:text-white font-semibold">
                          RRHH
                        </h3>
                      </div>
              ...
              {CheckPermissions(auth, [0, 4, 5, 14, 18, 32]) && (
                <div>
                  {mostrarCarga && (
                    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-white z-50">
                      <Image
