...
import { FactureRecaudaciones, ModalProps, ResponseData } from "../../types";
import { CheckPermissions } from "../../utils/check_permissions";
import HttpClient from "../../utils/http_client";

const initialFacture: FactureRecaudaciones = {
  id: null,
  //Solicitante
  project: {
    name: "RECAUDACIONES",
...
interface Props extends ModalProps<FactureRecaudaciones> {
  initialData?: FactureRecaudaciones;
}

const FactureRecaudacionesModal = (props: Props) => {
  const { auth } = useAuth();
  const [initialValues, setInitialValues] =
    useState<FactureRecaudaciones>(initialFacture);
  ...
  const formik = useFormik<FactureRecaudaciones>({
    enableReinitialize: true,
    validateOnMount: true,
    validateOnBlur: true,
    validateOnChange: true,
    initialValues,
    onSubmit: async (formData: FactureRecaudaciones) => {
...
export default FactureRecaudacionesModal;
