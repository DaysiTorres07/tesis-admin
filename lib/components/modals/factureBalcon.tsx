...
const initialFacture: FactureBalcon = {
  id: null,
  //Solicitante
  project: {
    name: "BALCON",
...
interface Props extends ModalProps<FactureBalcon> {
  initialData?: FactureBalcon;
}

const FactureBalconModal = (props: Props) => {
  const { auth } = useAuth();
  const [initialValues, setInitialValues] =
    useState<FactureBalcon>(initialFacture);
  ...
  const formik = useFormik<FactureBalcon>({
    enableReinitialize: true,
    validateOnMount: true,
    validateOnBlur: true,
    validateOnChange: true,
    initialValues,
    onSubmit: async (formData: FactureBalcon) => {
...
export default FactureBalconModal;
