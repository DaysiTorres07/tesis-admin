...
const initialFactureAdvance: FactureAdvanceInmogestion = {
  id: null,
  //Solicitante
  project: {
    name: "IG",
...
interface Props extends ModalProps<FactureAdvanceInmogestion> {
  initialData?: FactureAdvanceInmogestion;
}

const FactureAdvanceIgModal = (props: Props) => {
  const { auth } = useAuth();
  const [initialValues, setInitialValues] = useState<FactureAdvanceInmogestion>(
  ...
  const formik = useFormik<FactureAdvanceInmogestion>({
    enableReinitialize: true,
    validateOnMount: true,
    validateOnBlur: true,
    validateOnChange: true,
    initialValues,
    onSubmit: async (formData: FactureAdvanceInmogestion) => {
...
export default FactureAdvanceIgModal;
