...
import { AdvanceInmogestionModel } from "../../../lib/mongo/schemas";
import { AdvanceInmogestion } from "../../../lib/types";
...
export default async function handler(
  ...
  const advancesIg = await AdvanceInmogestionModel.find({
  ...
  if (req.query.dates !== undefined) {
    ...
    advancesIg.forEach((soli: AdvanceInmogestion) => {
    ...
    return res.status(200).json({
      ...
      data: advancesIg as Array<AdvanceInmogestion>,
      success: true,
    });
  }
}
