...
export default async function (
  ...
  const mailData = {
    ...
    <h4>DETALLE:</h4>
    <p>Se ingreso la Solicitud N°: <strong>${req.body.number}</strong>, de la empresa <strong>INMOCONSTRUCCIONES</strong>, por el Usuario: <strong>${req.body.soliciter}</strong>, realizar las tareas correspondientes.</p>
