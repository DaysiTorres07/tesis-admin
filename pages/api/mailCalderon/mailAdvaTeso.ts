...
export default async function (req: { body: { number: any; }; }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { status: string; }): void; new(): any; }; }; }) {
  ...
  const mailData = {
    ...
    html: `
          ...
          <h4>DETALLE:</h4>
          <p>Tesorería culmino su tarea del Anticipo N°: <strong>${req.body.number}</strong>, de la empresa <strong>CALDERON</strong>, por el Usuario: <strong>Pilar</strong>, realizar las tareas correspondientes.</p>
