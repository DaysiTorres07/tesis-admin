...
interface Props extends ModalProps<SolicitudeInmogestion> {
  initialData?: SolicitudeInmogestion;
}

const StatusSolicitudeIG = (props: Props) => {
  const { auth } = useAuth();
...
export default StatusSolicitudeIG;
