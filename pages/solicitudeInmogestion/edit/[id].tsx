...
const EditFacture = () => {
  ...
  const printSolicitudeInmogestion = () => {
    if (Router.asPath !== Router.route) {
      const solicitudeInmogestionId = Router.query.id as string;
      Router.push({
        pathname: "/solicitudeInmogestion/print/" + solicitudeInmogestionId,
      });
    } else {
      setTimeout(printSolicitudeInmogestion, 1000);
    }
  };
  ...
  return (
    <>
      <title>IG | Editar solicitud</title>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-6 gap-1">                  
                  ...
                  <button
                    ...
                    disabled={CheckPermissions(auth, [2, 3, 4, 5, 6, 9])}
                  >
                    Agregar Factura
                  </button>                
                  <button
                      ...
                      <div className="relative text-center w-40 mx-14  bg-white divide-y divide-gray-100 shadow-lg ring-1 ring-black ring-opacity-5">
                        {CheckPermissions(auth, [0, 8, 2, 3, 9]) && (
                          <button
                            ...
                            onClick={printSolicitudeInmogestion}
                          >
                            PDF
                          </button>
                        )}
              ...
              <div className="grid grid-cols-1 gap-4 m-2">
                      ...
                      <li
                        ...
                        className={`page-item ${
                          currentPage === pageNumber
                            ? "bg-slate-700 text-white rounded-full text-xs"
                            : ""
                        }`}
                      >
                        <a
                ...
                <div className="mx-16 my-2 py-2 px-8 text-left border rounded-lg bg-slate-100">
                  <p className="mt-1">
              ...
              COMENTARIOS
                  ...
                  <div className="grid md:grid-cols-2 grid-cols-1 w-2/4 m-4">
                    ...
                    <div className="mb-3">
                      <button
                        className="text-center bg-transparent hover:bg-gray-500 text-gray-500 font-semibold hover:text-white py-2 px-4 mt-2 border border-gray-500 hover:border-transparent rounded-full text-sm"
                        onClick={() => Router.back()}
                      >
                        Volver
                      </button>
