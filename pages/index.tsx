...
export default function Home() {
  ...
  const handleSolicitudes = () => {
    auth.role === 1 || auth.role === 8 || auth.role === 14
        ...
        <div className="w-12/12 md:w-5/6 bg-gradient-to-br from-slate-200 via-slate-300 to-slate-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 my-12">
              ...
              <div className="w-full h-full text-white font-semibold">
                <div className="grid grid-cols-6 justify-center items-center">
                  <div className="col-span-5">
                      <h1 className="md:text-4xl text-xl font-serif font-bold text-left"
                          style={{             
                          color: "#bb22dd",
                          fontSize: "20px",  
                      }}>
                      ...
                      <h2 className="font-sans text-left "
                          style={{             
                          color: "#2898db",
                      }}>
                          Pagos y Anticipos
                ...
                <ul className="text-sm p-2 ml-12">
                  ...
                  <li>
                    <button
                      ...
                      disabled={!CheckPermissions(auth, [0, 3, 4, 5, 9, 10])}
                    >
                      Nomina de Pagos
                    </button>
                  </li>
                  <li>
                    ...
                    >
                      Historial Solicitudes/Anticipos
                    </button>
                  </li>                  
                </ul>
              </div>
              ...
              <div className="w-full h-full text-white font-semibold">
                ...
                <ul className="text-sm p-2 ml-12">
                  <li>
                    <button
                      className="p-1 md:text-md rounded-full hover:bg-slate-300 text-gray-600 px-8 bg-slate-200 m-2"
                      onClick={handleAppHolidays}
                      disabled={CheckPermissions(auth, [6, 7])}
                    >
                      Ir al Aplicativo
                    </button>
                  </li>
            ...
            {/* <button
              ...
              disabled={CheckPermissions(auth, [6, 7])}
            >
              <div className="bg-gray-900 p-4 rounded-lg w-3/4 m-auto block">
                <div className="w-full h-full text-white font-semibold text-lg">
                  <h1 className="md:text-4xl text-xl font-serif font-bold text-center">
                    RR HH
                  </h1>
                  <h2 className="md:text-sm text-xs font-sans text-center mb-4">
                    Permisos y Préstamos
                  </h2>
                </div>
