                      ...
                      {item.items.map((facture: Facture) => (
                        <>
                          <tbody>
                            ...
                            >
                              {facture.centerCostCalderon.name ?? ""}
                            </td>
                            <td
                              style={{
                                border: "1px solid",
                      ...
                      {item.items.map((facture: Facture) => (
                        <>
                          <tbody>
                            ...
                            >
                              {facture.providerRecaudaciones.name ?? ""}
                            </td>
                            <td
                              style={{
                                border: "1px solid",
