...
const ExcelSolicitudeBalcon = () => {
  const { auth } = useAuth();
  const [loading, setLoading] = useState(true);
  const [solicitude, setSolicitude] = useState<SolicitudeBalcon>(null);
  ...
  function exportToExcel() {
    ...
    downloadLink.download = "Solicitud-Balcon.xls";
    downloadLink.click();
  ...
  return (
    <>
      <title>Balcon | Excel Solicitud</title>
            ...
            <table width="95%" align="center" className="text-base">
              <tr>
                ...
                <td>
                  ...
                  {solicitude.items
                    .reduce(
                      (partialSum, facture) => partialSum + facture.difference,
                      0
                    )
...
export default ExcelSolicitudeBalcon;
