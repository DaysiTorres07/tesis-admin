...
interface Props extends ModalProps<SolicitudeCalderon> {
  initialData?: SolicitudeCalderon;
}

const StatusSolicitudeCalderon = (props: Props) => {
  const { auth } = useAuth();
  const [initialValues, setInitialValues] = useState<SolicitudeCalderon>(null);
...
export default StatusSolicitudeCalderon;
