...
const EditFacture = () => {
  ...
  const printSolicitude = () => {
    if (Router.asPath !== Router.route) {
      const solicitudeId = Router.query.id as string;
      Router.push({ pathname: "/solicitudeCalderon/print/" + solicitudeId });
    } else {
  ...
  const txtPichincha = () => {
    if (Router.asPath !== Router.route) {
      const solicitudeId = Router.query.id as string;
      Router.push({ pathname: "/solicitudeCalderon/txt/" + solicitudeId });
    } else {
  ...
  return (
    <>
      <title>Calderon | Historial de solicitud</title>
