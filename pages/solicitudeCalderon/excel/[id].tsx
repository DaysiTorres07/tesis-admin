...
const ExcelSolicitudeCalderon = () => {
  const { auth } = useAuth();
  const [loading, setLoading] = useState(true);
  const [solicitude, setSolicitude] = useState<SolicitudeCalderon>(null);
  ...
  function exportToExcel() {
    ...
    downloadLink.download = "Solicitud-calderon.xls";
    downloadLink.click();
  ...
  return (
    <>
      <title>Calderon | Excel Solicitud</title>
...
export default ExcelSolicitudeCalderon;
