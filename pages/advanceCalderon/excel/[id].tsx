...
const ExcelAdvanceCalderon = () => {
  const { auth } = useAuth();
  const [loading, setLoading] = useState(true);
  const [advance, setAdvance] = useState<AdvanceCalderon>(null);
  ...
  function exportToExcel() {
    ...
    downloadLink.download = "Anticipo-Calderon.xls";
    downloadLink.click();
  ...
  return (
    <>
      <title>Calderon | Excel Anticipo</title>
                ...
                <tbody>
                  {advance.items.map((item, index) => (
                    <tr key={index} style={{ textAlign: "center" }}>
                      ...
                      <td className="border border-black">{item.centerCostCalderon?.name ?? ""}</td>
                      <td className="border border-black">{item.providerCalderon?.name ?? ""}</td>
...
export default ExcelAdvanceCalderon;
