...
import PermissionHistory from "./permission/history/permissionHistory";
import PermissionHistoryRe from "./permission/history/permissionHistoryRe";
...
const HistoryPermission = () => {
  ...
  const tabPanels: Array<TabPanel> = [
    {
      name: "Aprobada",
      content: <PermissionHistory />,
    },
    {
      name: "Rechazada",
      content: <PermissionHistoryRe />,
    },
  ];
  return (
    <>
